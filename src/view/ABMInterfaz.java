...
//		btnAgregar.setBorder(new LineBorder(Color.GREEN));
		btnAgregar.setBackground( Constantes.COLOR_VERDE );
		...
		btnListar.setBounds(896, 110, 120, 25);
		getContentPane().add(btnListar);

		btnOrdenar = new JButton("Ordenar libros");
		btnOrdenar.setBounds(896, 146, 120, 25);
		getContentPane().add(btnOrdenar);

		btnEliminar = new JButton("Eliminar libro");
//		btnEliminar.setBorder(new LineBorder(Color.RED));
		btnEliminar.setBackground( Constantes.COLOR_ROJO );
		btnEliminar.setForeground(Color.WHITE);
		btnEliminar.setBounds(893, 382, 120, 25);
		getContentPane().add(btnEliminar);

		btnModificar = new JButton("Modificar libro");
		btnModificar.setBorder(new LineBorder(Color.BLUE));
		btnModificar.setBounds(893, 346, 120, 25);
